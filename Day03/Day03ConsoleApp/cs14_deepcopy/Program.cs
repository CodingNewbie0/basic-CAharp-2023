...
namespace cs14_deepcopy
{
    class SomeClass
    {
        ...
        public SomeClass DeepCopy()
        {
            ...
            newCopy.SomeField1 = this.SomeField1; // Call by return
    ...
    class ThisClass // 오버로딩 : 같은 이름의 메서드를 여러개 사용
    {
        int a, b, c;
    ...
    internal class Program
    {
        ...
        {
            Console.WriteLine("얕은 복사 시작"); // source와 target이 (주소복사) 값이 공유된다. (조심해서 사용)
